...
export const DEFAULT_TEXT: Record<string, string> = {
  ...
  "import.contacts.intro": "Upload a CSV with one contact per row — from a spreadsheet, a LinkedIn export, or the template below.",
  "import.contacts.done": "{n} contacts added to your network.",
  "import.opportunities.title": "Import jobs",
  "import.opportunities.intro": "Upload a CSV with one job per row. Import your contacts first if you want to attach them by email or name.",
