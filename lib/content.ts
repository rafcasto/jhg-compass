...
export const TEXT_FIELDS: TextField[] = [
  ...
  { group: "Progress (Tracker)", key: "tracker.f.contactType", label: "Field — Contact type" },
  { group: "Progress (Tracker)", key: "tracker.f.phone", label: "Field — Phone number" },
  { group: "Progress (Tracker)", key: "tracker.f.optional", label: "Optional-field suffix" },
  { group: "Progress (Tracker)", key: "tracker.f.ct.hiringManager", label: "Contact type option — Hiring manager" },
  { group: "Progress (Tracker)", key: "tracker.f.ct.peer", label: "Contact type option — Peer" },
  { group: "Progress (Tracker)", key: "tracker.f.ct.influencer", label: "Contact type option — Influencer" },
  { group: "Progress (Tracker)", key: "tracker.f.ct.referrer", label: "Contact type option — Referrer" },
  ...
  // ----- Progress (Tracker) — CSV import (contacts + jobs) -----
  { group: "Progress (Tracker)", key: "tracker.import", label: "Import — “Import CSV” button" },
  { group: "Progress (Tracker)", key: "import.contacts.title", label: "Import — contacts sheet title" },
  { group: "Progress (Tracker)", key: "import.contacts.intro", label: "Import — contacts intro", textarea: true },
  { group: "Progress (Tracker)", key: "import.contacts.done", label: "Import — contacts success", help: "Use {n} for the number imported." },
  { group: "Progress (Tracker)", key: "import.contacts.linked", label: "Import — contacts attached note", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.contacts.autoLink", label: "Import — contacts auto-attach checkbox" },
  { group: "Progress (Tracker)", key: "import.opportunities.title", label: "Import — jobs sheet title" },
  { group: "Progress (Tracker)", key: "import.opportunities.intro", label: "Import — jobs intro", textarea: true },
  { group: "Progress (Tracker)", key: "import.opportunities.done", label: "Import — jobs success", help: "Use {n} for the number imported." },
  { group: "Progress (Tracker)", key: "import.opportunities.linked", label: "Import — jobs attached note", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.opportunities.autoLink", label: "Import — jobs auto-attach checkbox" },
  { group: "Progress (Tracker)", key: "import.jobs", label: "Import — “Jobs” preview column" },
  { group: "Progress (Tracker)", key: "import.template", label: "Import — “Download template” button" },
  { group: "Progress (Tracker)", key: "import.chooseFile", label: "Import — “Choose CSV file” button" },
  { group: "Progress (Tracker)", key: "import.pasteToggle", label: "Import — “paste” toggle" },
  { group: "Progress (Tracker)", key: "import.pastePlaceholder", label: "Import — paste placeholder" },
  { group: "Progress (Tracker)", key: "import.preview", label: "Import — “Preview” button" },
  { group: "Progress (Tracker)", key: "import.columns", label: "Import — column guide heading" },
  { group: "Progress (Tracker)", key: "import.required", label: "Import — “required” tag" },
  { group: "Progress (Tracker)", key: "import.ready", label: "Import — ready count", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.errors", label: "Import — skipped count", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.duplicates", label: "Import — skip-duplicates checkbox", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.warnings", label: "Import — warnings heading", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.line", label: "Import — line prefix", help: "Use {n} for the line number." },
  { group: "Progress (Tracker)", key: "import.missingColumns", label: "Import — missing column error", help: "Use {cols}." },
  { group: "Progress (Tracker)", key: "import.empty", label: "Import — empty file error", textarea: true },
  { group: "Progress (Tracker)", key: "import.tooMany", label: "Import — row limit note", help: "Use {n} for the limit." },
  { group: "Progress (Tracker)", key: "import.submit", label: "Import — submit button", help: "Use {n}." },
  { group: "Progress (Tracker)", key: "import.busy", label: "Import — busy label" },
  { group: "Progress (Tracker)", key: "import.back", label: "Import — “choose another file”" },
  { group: "Progress (Tracker)", key: "import.close", label: "Import — close button" },
  { group: "Progress (Tracker)", key: "import.nothing", label: "Import — nothing-to-import text" },
  ...
  { group: "Set password / verify link", key: "auth.setpw.body", label: "Set password — subtext", textarea: true },
  { group: "Set password / verify link", key: "auth.setpw.doneTitle", label: "Set password — success heading" },
  { group: "Set password / verify link", key: "auth.setpw.continue", label: "Set password — continue button" },
...
export const DEFAULT_TEXT: Record<string, string> = {
  ...
  "tracker.f.contactType": "Contact type",
  "tracker.f.phone": "Phone number",
  "tracker.f.optional": "(Optional)",
  "tracker.f.ct.hiringManager": "Hiring manager",
  "tracker.f.ct.peer": "Peer",
  "tracker.f.ct.influencer": "Influencer",
  "tracker.f.ct.referrer": "Referrer",
  ...
  // CSV import
  "tracker.import": "Import CSV",
  "import.contacts.title": "Import contacts",
  "import.contacts.intro": "Upload a CSV with one contact per row — from a spreadsheet, a LinkedIn export, or the template below. Contacts are attached to the jobs on your board at the same company.",
  "import.contacts.done": "{n} contacts added to your network.",
  "import.contacts.linked": "{n} attached to jobs on your board.",
  "import.contacts.autoLink": "Attach each contact to the jobs at their company",
  "import.opportunities.title": "Import jobs",
  "import.opportunities.intro": "Upload a CSV with one job per row. Contacts already on your list are attached by email, name, or company.",
  "import.opportunities.done": "{n} jobs added to your board.",
  "import.opportunities.linked": "{n} have contacts attached.",
  "import.opportunities.autoLink": "Attach the contacts you already have at each company",
  "import.jobs": "Jobs",
  "import.template": "Download template",
  "import.chooseFile": "Choose CSV file",
  "import.pasteToggle": "Or paste CSV text",
  "import.pastePlaceholder": "Paste CSV here — first line must be the column headers",
  "import.preview": "Preview",
  "import.columns": "Columns",
  "import.required": "required",
  "import.ready": "{n} ready to import",
  "import.errors": "{n} skipped",
  "import.duplicates": "Skip {n} already on your list",
  "import.warnings": "{n} warnings",
  "import.line": "Line {n}",
  "import.missingColumns": "Missing required column: {cols}",
  "import.empty": "No rows found. The first line must be the column headers, followed by at least one row.",
  "import.tooMany": "Only the first {n} rows will be imported.",
  ...
  "auth.setpw.done": "Your password has been updated. Redirecting you to sign in…",
  "auth.setpw.body": "Choose a new password for your JobHacker Compass account.",
  "auth.setpw.doneTitle": "Password updated",
  "auth.setpw.continue": "Continue to sign in",
