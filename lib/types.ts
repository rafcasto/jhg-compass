...
export interface CompassFormula {
  ...
  industry?: string;
  geography?: string;
  companyType?: string; // legacy bare values: startup / small / mid-size / large
...
export interface AccessGrant {
  ...
  // careerOps: the member can switch to the CareerOps portal (career-ops on the Pi). Admin SDK writes only.
