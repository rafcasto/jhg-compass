...
.cl-hero__sub{font-size:17px;line-height:1.62;color:#6b7280;margin:0 auto 30px;max-width:30em;}
...
.cl-mentors{max-width:660px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:18px;}
